...
public class RecommendController {
    ...
    @ApiOperation(value = "비슷한 공연 목록 조회", notes = "한 공연에 대해 비슷한 공연 목록을 조회합니다.")
    ...
    public ResponseEntity<BaseResponseBody> getRecommendPerformanceList(@PathVariable Long performanceId) {
        return ResponseEntity.ok(BaseResponseBody.of(HttpStatus.OK, GET_RECOMMEND, recommendService.getRecommendPerformanceList(performanceId)));
    }
